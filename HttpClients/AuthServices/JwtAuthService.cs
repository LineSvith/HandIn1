...
public class JwtAuthService : IAuthService
{
    ...
    public async System.Threading.Tasks.Task LoginAsync(string username, string password)
    {
    ...
    public async System.Threading.Tasks.Task RegisterAsync(AuthenticationUser user)
    {
    ...
    {
        ClaimsPrincipal principal = CreateClaimsPrincipal();
        return System.Threading.Tasks.Task.FromResult(principal);
    }
